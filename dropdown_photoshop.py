...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        hbox5.Add(self.label, 0 , wx.EXPAND |wx.ALIGN_CENTER_HORIZONTAL |wx.ALL, 20)
        cblbl = wx.StaticText(panel,label = "Combo box",style = wx.ALIGN_CENTRE)

        hbox5.Add(cblbl,0,wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALL,9)
        options = ['btn_invert', "btn_gray_scale","btn_posterize","btn_solarize", "btn_darken", "btn_brighten", "btn_crop", "btn_blur", "btn_sharpen"]
        self.combo = wx.ComboBox(panel,choices = options)

        hbox5.Add(self.combo,1,wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALL,9)
        chlbl = wx.StaticText(panel,label = "Choice control",style = wx.ALIGN_CENTRE)

        hbox5.Add(chlbl,0,wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALL,9)
        self.choice = wx.Choice(panel,choices = options)
        hbox5.Add(self.choice,1,wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALL,9)
...
def main():
    app = wx.App()
    Example(None,  'BRAAAAAAGH! I AM JHFKJGLSHHJBLSAVKDF, THE WARRIOR, FEAR ME')
    app.MainLoop()
